...
class WordlistLoader {
  static Map<Wordlist, WordlistMetadata> wordlistToMetadata = {
    Wordlist.bip39_zh_CW:
        new WordlistMetadata(uiName: "BIP39 Chinese Simplified", tags: ["BIP39"], locale: "zh_CW", numWords: 2048),
    Wordlist.bip39_zh_TW:
        new WordlistMetadata(uiName: "BIP39 Chinese Traditional", tags: ["BIP39"], locale: "zh_TW", numWords: 2048),
    ...
    Wordlist.diceware_beale_en: new WordlistMetadata(
    ...
    Wordlist.diceware_en:
        new WordlistMetadata(uiName: "Diceware English (7776 words)", tags: ["Diceware"], locale: "en", numWords: 7776),
    Wordlist.diceware_8k_en:
        new WordlistMetadata(uiName: "Diceware English (8k words)", tags: ["Diceware"], locale: "en", numWords: 8192),
    Wordlist.eff_large_en: new WordlistMetadata(
        uiName: "EFF Long list (7776 words)",
        tags: ["EFF"],
        locale: "en",
        numWords: 7776,
        info: "improved usability -- easier to spell, less confusing words."),
    Wordlist.eff_short_v1_en: new WordlistMetadata(
        uiName: "EFF Short list (v1 - 1296 words)",
        tags: ["EFF"],
        locale: "en",
        numWords: 1296,
        info: "shorter words (max 5 chars), more memorable and distinct."),
    Wordlist.eff_short_v2_en: new WordlistMetadata(
  ...
  static Map<Wordlist, AbstractWordlistLoader> wordlistToLoader = {
    Wordlist.bip39_zh_CW:
        new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/bip39/chinese_simplified.txt"),
    Wordlist.bip39_zh_TW:
        new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/bip39/chinese_traditional.txt"),
    Wordlist.bip39_en: new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/bip39/english.txt"),
    Wordlist.bip39_fr: new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/bip39/french.txt"),
    Wordlist.bip39_it: new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/bip39/italian.txt"),
    Wordlist.bip39_ja: new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/bip39/japanese.txt"),
    Wordlist.bip39_ko: new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/bip39/korean.txt"),
    Wordlist.bip39_es: new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/bip39/spanish.txt"),
    Wordlist.diceware_beale_en:
        new DicewareWordlistLoader(uri: "package:dart_wordlists/wordlists/diceware/beale.wordlist.asc"),
    Wordlist.diceware_en:
        new DicewareWordlistLoader(uri: "package:dart_wordlists/wordlists/diceware/diceware.wordlist.asc"),
    Wordlist.diceware_8k_en: new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/diceware/diceware8k.txt"),
    Wordlist.eff_large_en:
        new DicewareWordlistLoader(uri: "package:dart_wordlists/wordlists/eff/eff_large_wordlist.txt"),
    Wordlist.eff_short_v1_en:
        new DicewareWordlistLoader(uri: "package:dart_wordlists/wordlists/eff/eff_short_wordlist_1.txt"),
    Wordlist.eff_short_v2_en:
        new DicewareWordlistLoader(uri: "package:dart_wordlists/wordlists/eff/eff_short_wordlist_2_0.txt"),
    Wordlist.pgp_even: new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/pgp/pgp_even.txt"),
    Wordlist.pgp_odd: new SimpleWordlistLoader(uri: "package:dart_wordlists/wordlists/pgp/pgp_odd.txt"),
  };
  ...
  AbstractWordlistLoader findLoader(Wordlist wordlist) {
    if (!wordlistToLoader.containsKey(wordlist)) throw new ArgumentError("Invalid wordlist val: $wordlist");
    return wordlistToLoader[wordlist];
  }

  WordlistMetadata findMetadata(Wordlist wordlist) {
    if (!wordlistToMetadata.containsKey(wordlist)) throw new ArgumentError("Invalid wordlist val: $wordlist");
